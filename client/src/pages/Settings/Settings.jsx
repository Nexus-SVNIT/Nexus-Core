...
// import { Table } from "../components/UI/TableSettings";
                ...
                <form action="#">
                  <div className="mb-5.5 gap-5.5 flex flex-col sm:flex-row">
                    ...
                    <div className="w-full sm:w-1/2">
                      ...
                      <input
                        className="border-stroke bg-gray px-4.5 focus:border-primary dark:border-strokedark dark:bg-meta-4 dark:focus:border-primary w-full rounded border py-3 text-black focus-visible:outline-none dark:text-white"
                        type="text"
                        name="phoneNumber"
                        id="phoneNumber"
              ...
              <div className="p-7">
                <form action="#">
                  ...
                  <div className="gap-4.5 flex justify-end">
                    ...
                    <button
                      className="bg-primary text-gray flex justify-center rounded px-6 py-2 font-medium hover:bg-opacity-70"
                      type="submit"
                    >
                      Save
                    </button>
