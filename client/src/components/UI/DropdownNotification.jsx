  ...
  return (
    <li className="relative">
      ...
      <div
        ...
        className={`-right-27 h-90 w-75 border-stroke shadow-default dark:border-strokedark dark:bg-boxdark absolute left-auto mt-2.5 flex flex-col rounded-sm border bg-white sm:right-0 sm:w-80 ${
